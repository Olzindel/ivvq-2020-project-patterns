...
public class OrderMutationIntegrationTest {
    ...
    void createOrder() {
        ...
        assertEquals(order.getId(), orderItemMutation.getOrderItemService().findOrderItemById(orderItem.getId()).getOrder().getId());
    ...
    void deleteOrder() {
        ...
        assertThrows(OrderItemNotFoundException.class, () -> orderItemMutation.getOrderItemService().findOrderItemById(orderItem.getId()));
        assert !userMutation.getUserService().findUserById(user.getId()).getOrders().contains(order);
    }
