...
public class UserMutationIntegrationTest {
  ...
  void createUser() {
    ...
    assertEquals(
        user, merchantMutation.getMerchantService().findMerchantById(merchant.getId()).getAdmin());
  }
  ...
  void deleteUser() {
    ...
    assertThrows(
        ...
        () -> merchantMutation.getMerchantService().findMerchantById(merchant.getId()));
    assertThrows(
        OrderNotFoundException.class,
        () -> orderMutation.getOrderService().findOrderById(order.getId()));
  }
