...
public class Dataloader implements ApplicationRunner {
  ...
  private void initProduct() {
    ...
    ProductInput inoriYuzurihaInput =
            new ProductInput("Inori Yuzuriha", 16f, ProductStatus.AVAILABLE, "", 4, null);
    ProductInput lucinaInput =
            new ProductInput("Lucina", 16f, ProductStatus.AVAILABLE, "", 4, null);
    ProductInput corrinInput =
            new ProductInput("Corrin", 16f, ProductStatus.AVAILABLE, "", 4, null);
    ...
    ImageLinkInput inoriImageLink =
            new ImageLinkInput(
                    "https://www.anime-planet.com/images/characters/inori-yuzuriha-30505.jpg?t=1571074008",
                    inoriYuzuriha.getId());
    ImageLinkInput lucinaImageLink =
            new ImageLinkInput(
                    "https://static.zerochan.net/Lucina.%28Fire.Emblem%29.full.2681058.jpg",
                    lucina.getId());
    ImageLinkInput corrinImageLink =
            new ImageLinkInput(
                    "https://66.media.tumblr.com/340f4287378a2f5d33f1f4821fae1ba3/tumblr_pga9xi6Fml1u8syzno1_400.png",
                    corrin.getId());
